...
class PRM:
    def __init__(self, num_samples, local_planner, num_dimensions, lims = None,
        ...
        self.sigma = sigma # To control Gaussian sampling variance
    ...
    def find_valid_neighbors(self, n_query, samples, r):
        ...
        '''
        valid_neighbors = []
        raise NotImplementedError('Find samples within radius r of n_query that is collision free')
    ...
    def graph_search(self, init_node, is_goal):
        '''
    ...
    def sample(self):
        ...
        '''
        raise NotImplementedError('Implement uniform sampling')

    def gaussian_sample(self):
        '''
        Sample a configuration, then sample another configuration around the first
        Return the configuration if either of them in collision
        '''
        raise NotImplementedError('Implement Gaussian sampling')
...
def test_prm_env(num_samples=200, step_length=0.1, env='./env0.txt',
                 use_gaussian=False, sigma=5.0, radius=2.0):
    ...
    # Add other start and goal queries and visualize
...
def main():
    parser = argparse.ArgumentParser(description="Probabilistic Road Maps")
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Radius for nearest neighbor search",
    )
    ...
    parser.add_argument(
        "--use_gaussian",
        action="store_true",
        help="Use Gaussian sampling (might have to set --gauss_scale)",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=2.0,
        help="Scale for Gaussian sampling",
    )
    ...
    kwargs['env'] = args.env
    kwargs['use_gaussian'] = args.use_gaussian
    kwargs['sigma'] = args.gauss_scale
